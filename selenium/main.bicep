// Taken from quickstart template
// https://github.com/Azure/azure-quickstart-templates/blob/master/quickstarts/microsoft.sqlvirtualmachine/sql-vm-new-storage/main.bicep

@description('The name of the VM')
param virtualMachineName string = 'SeleniumTestVm'
